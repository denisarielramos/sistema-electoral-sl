...
const ModalDireccion = ({ tipo, persona, onSave, onClose }) => {
  const [direccion, setDireccion] = useState("");
  const [saving, setSaving] = useState(false);

  // Inicializar con la dirección actual de la persona cada vez que se abre
  useEffect(() => {
    if (persona) {
      setDireccion(persona.direccion_override || persona.direccion || "");
    }
  }, [persona]);
